...
#         name="Note_Create",
#         description= "Gunakan untuk membuat note baru. "
#                     "Field 'notes' adalah list, jadi bisa bikin banyak catatan sekaligus. disini hanya buat note saja tidak ada yang lain."
#                     "Misalnya, kalau user minta 'satu hari penuh', buatkan catatan pagi, siang, sore, malam."
#                     "Input harus berupa JSON dengan field notes:[hari, jam = HH:MM:SS, judul_note, description_note].",
